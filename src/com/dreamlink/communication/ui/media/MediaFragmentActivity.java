...
public class MediaFragmentActivity extends FragmentActivity implements TabContentFactory, OnTabChangeListener{
	...
	public void initViews(){
		...
		mTabHost.addTab(mTabHost.newTabSpec(TAG_ONE).setIndicator("音频").setContent(R.id.media_frag1));
		mTabHost.addTab(mTabHost.newTabSpec(TAG_TWO).setIndicator("视频").setContent(R.id.media_frag2));
